...
% Last Modified by GUIDE v2.5 10-Jul-2013 14:25:42
...
set(handles.pushbutton_1,'Visible','off');
set(handles.pushbutton_2,'Visible','on');
...
set(handles.pushbutton_1,'Visible','on');
set(handles.pushbutton_2,'Visible','off');
set(handles.edit1,'Visible','off');
set(handles.edit1,'Visible','on');
